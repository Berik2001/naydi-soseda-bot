...
def ask_listing_desc(gender: str | None) -> str:
    ...
    if gender == "male":
        example = (
            "2-комнатная, есть мебель, рядом метро. Ищу 2 парней для "
            "проживания — спокойные, учатся или работают, 18–25 лет"
        )
    elif gender == "female":
        example = (
            "2-комнатная, есть мебель, рядом метро. Ищу 2 девушек для "
            "проживания — спокойные, учатся или работают, 18–25 лет"
        )
    else:
        example = "2 комнаты, есть мебель, рядом метро. Ищу соседей 18–25 лет"
    return (
