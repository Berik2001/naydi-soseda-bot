...
# Премиум (заглушка — платёжный провайдер ещё не подключён)
PREMIUM_INFO = (
    "⭐ <b>Премиум</b> — скоро!\n\n"
    "Что планируется в премиуме:\n"
    "• 🔝 Поднятие анкеты в топ выдачи\n"
    "• ♾️ Безлимитные супер-лайки\n"
    "• 👀 Кто меня лайкнул\n"
    "• 🚫 Без рекламы\n\n"
    "Оплата будет через Telegram Stars ⭐. Следи за обновлениями!"
)
