...
# Текст кнопки «Готово» на нижней клавиатуре при загрузке нескольких фото/видео.
# Один и тот же литерал используется и для кнопки, и для фильтра-обработчика.
PHOTOS_DONE_BTN = "Готово ✅"
ASK_APARTMENT_PHOTOS = (
    "📸 Пришли фото квартиры (можно несколько, до 10).\n"
    "Когда закончишь — нажми кнопку «Готово ✅» под этим сообщением."
)
ASK_LISTING_DESC = (
    "✍️ Опиши жильё:\n"
